            ...
            VStack{
                ...
                ZStack{
                    ...
                    VStack{
                        ...
                        HStack(spacing: 10){
                            Text("Parsley Bay").font(.title3).fontWeight(.bold).foregroundColor(Color("homebutton")).offset(y: 50)
                            Text("|").font(.title).foregroundColor(Color("homebutton")).offset(y: 50)
                            Text("Vaucluse").font(.subheadline).fontWeight(.bold).foregroundColor(Color("homebutton")).offset(y: 50)
                        }
                        
                    }
                    
                    Image("Parsley").resizable().clipShape(Circle()).shadow(radius: 10).overlay(Circle().stroke(Color.blue, lineWidth: 2)).frame(width: 140, height: 140).offset(y: -10)
                }
