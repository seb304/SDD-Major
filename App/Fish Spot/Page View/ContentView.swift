        ...
        NavigationView{
            ZStack{
                ...
                VStack(spacing: 5){
                    ...
                    Spacer()
                    VStack(spacing: 0){
                        NavigationLink(destination: CameraView().navigationBarBackButtonHidden(true).aspectRatio(contentMode: .fit)){
                            ZStack{
                                Rectangle().fill(Color("homebutton")).frame(width: 340, height: 70).cornerRadius(15).aspectRatio(contentMode: .fit).padding(.bottom)
                                HStack{
                        ...
                        HStack{
                            NavigationLink(destination: CollectionView().navigationBarBackButtonHidden(true).aspectRatio(contentMode: .fit)){
                                ZStack{
                                    Rectangle().fill(Color("homebutton")).frame(width: 170, height: 70).cornerRadius(15).aspectRatio(contentMode: .fit).padding([.leading, .bottom])
                                    HStack(spacing: 1){
                            ...
                            NavigationLink(destination: WeatherView().navigationBarBackButtonHidden(true).aspectRatio(contentMode: .fit)){
                                ZStack{
                                    Rectangle().fill(Color("homebutton")).frame(width: 170, height: 70).cornerRadius(15).aspectRatio(contentMode: .fit).padding([.bottom, .trailing])
                                    HStack(spacing: 0){
                        ...
                        HStack{
                            NavigationLink(destination: LawView().navigationBarBackButtonHidden(true).aspectRatio(contentMode: .fit)){
                                ZStack{
                                    Rectangle().fill(Color("homebutton")).frame(width: 170, height: 70).cornerRadius(15).aspectRatio(contentMode: .fit).padding([.leading, .bottom])
                                    HStack(spacing: 1){
                            ...
                            NavigationLink(destination: FishingspotView().navigationBarBackButtonHidden(true).aspectRatio(contentMode: .fit)){
                                ZStack{
                                    Rectangle().fill(Color("homebutton")).frame(width: 170, height: 70).cornerRadius(15).aspectRatio(contentMode: .fit).padding([.bottom, .trailing])
                                    HStack{
